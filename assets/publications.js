...
window.RTR_PUBLICATIONS = [
  ...
  },
  {
    ...
    "standfirst": "Caste, democracy, and the public library in the Indian city — how Ahmedabad and Delhi keep the library on paper while withdrawing it as a public.",
    "date": "2026-06",
    "version": "v0.2.0",
    "status": "Draft",
    "subjects": [
    ...
    "citation": "Right To Read Campaign (2026). Whom Does the City Allow to Read?: Caste, Democracy, and the Public Library in the Indian City. Right to Read Working Papers, RTR-WP-006 (v0.2.0). https://theright2read.org/papers/RTR-WP-006.pdf"
  },
  {
    "kind": "paper",
    "id": "RTR-WP-008",
